...
const YOUTUBE_VIDEO_ID = "9n0AOzuccuo";
    ...
    <div className="space-y-16">
      ...
      <section className="text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-3">
          <Button asChild size="lg"><Link href={localizeHref("/guide/murder-duels-guide", locale)}>{home.hero.primaryCta}<ArrowRight className="ml-2 h-4 w-4" /></Link></Button>
          <Button asChild size="lg" variant="outline"><Link href={localizeHref("/values/murder-duels-values", locale)}>{home.hero.secondaryCta}</Link></Button>
          <Button asChild size="lg" variant="outline"><Link href={localizeHref("/codes/murder-duels-codes", locale)}>{home.hero.tertiaryCta}</Link></Button>
        </div>
      </section>
