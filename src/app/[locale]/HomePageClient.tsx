...
const YOUTUBE_VIDEO_ID = "i4saK4C85pM";
                    ...
                    <div className="space-y-3">
                      {mod.highlights.map((h, i) => (
                        <div key={i} className="flex items-center justify-between gap-4 rounded-xl border border-border bg-muted p-4">
                          ...
                          {"badge" in h && typeof h.badge === "string" && h.badge && (
                            <Badge className="shrink-0 bg-emerald-600 text-white text-[10px]">{h.badge}</Badge>
                          )}
                        </div>
                      ))}
                    </div>
